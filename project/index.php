                ...
                <div class="swiper swiper-controller">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="images/gallery/1.jpg" class="img-fluid  d-block"/>
                            </div>
                            <div class="swiper-slide">
                                <img src="images/gallery/2.jpg"class="img-fluid  d-block"/>
                            </div>
                            <div class="swiper-slide">
                                <img src="images/gallery/3.jpg" class="img-fluid  d-block"/>
                            </div>
                            <div class="swiper-slide">
                                <img src="images/gallery/4.jpg" class="img-fluid  d-block"/>
                            </div>
        ...
        <div class="container mb-5">
            <div class="row justify-content-evenly px-lg-0 px-md-0 px-5">
                <div class="col-lg-2 col-md-2 text-center bg-white rounded shadow py-4 my-3">
                   <img src="images\features\1.svg.svg" width="80px"> 
