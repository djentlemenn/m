...
<div class="container">
    <div class="row justify-content-between align-items-center">
        ...
        <div class="col-lg-5 col-md-5 mb-4 order-lg-2 order-md-2 order-1">
            <img src="images/aboutus/vv.jpeg.jpg" width="420px" alt="">
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-lg-3 col-md-6 mb-4 px-4 ">
            <div class="bg-white rounded shadow p-4 border-top border-4 text-center box">
                <img src="images/aboutus/hotel.svg" width="70px" alt="">
        ...
        <div class="col-lg-3 col-md-6 mb-4 px-4 ">
            <div class="bg-white rounded shadow p-4 border-top border-4 text-center box">
                <img src="images/aboutus/customers.png" width="70px" alt="">
        ...
        <div class="col-lg-3 col-md-6 mb-4 px-4 ">
            <div class="bg-white rounded shadow p-4 border-top border-4 text-center box">
                <img src="images/aboutus/review.svg" width="70px" alt="">
        ...
        <div class="col-lg-3 col-md-6 mb-4 px-4 ">
            <div class="bg-white rounded shadow p-4 border-top border-4 text-center box">
                <img src="images/aboutus/staffs.png" width="70px" alt="">
    ...
    <div class="swiper mySwiper">
        <div class="swiper-wrapper mb-5">
            <div class="swiper-slide bg-white text-center overflow-hidden rounded-3">
                <img src="images/aboutus/team1.jfif" class="w-100">
